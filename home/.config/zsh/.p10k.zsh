# Generated by Powerlevel10k configuration wizard on 2026-04-23 at 20:51 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # Version-manager segments removed: this setup uses mise for every
    # runtime, and powerlevel10k (frozen since 2024-01) has no mise segment.
    # asdf/pyenv/goenv/nodenv/nvm/rbenv/luaenv/jenv/plenv/phpenv/scalaenv/
    # haskell_stack all rendered nothing once those tools were removed.
