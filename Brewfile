...
vscode "ankitaabad.mantine-snippets-pro"
vscode "anthropic.claude-code"
vscode "astro-build.astro-vscode"
vscode "barrettotte.ibmi-languages"
...
vscode "vhdlwhiz.vhdl-by-vhdlwhiz"
